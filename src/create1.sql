...
CREATE TABLE IF NOT EXISTS Area (
    ...
    CONSTRAINT positiveRecommendedLevel CHECK (recommendedLevel > 0)
);
...
CREATE TABLE IF NOT EXISTS NonPlayableCharacter (
    entityID INTEGER PRIMARY KEY,
    dialogue TEXT,
...
CREATE TABLE IF NOT EXISTS MonsterDrop (
    itemID INTEGER PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS ItemWithFunction (
    itemID INTEGER PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS MagicWeapon (
...
CREATE TABLE IF NOT EXISTS MeleeWeapon (
    weaponID INTEGER PRIMARY KEY,
